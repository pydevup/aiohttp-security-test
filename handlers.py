...
class Web(object):
    ...
    async def login(self, request: web.Request) -> NoReturn:
        invalid_resp = web.HTTPUnauthorized(body=b"Invalid username/password combination", content_type='text/html')
    ...
    async def logout(self, request: web.Request) -> web.Response:
        ...
        response = web.Response(body=b'You have been logged out', content_type='text/html')
    ...
    async def internal_page(self, request: web.Request) -> web.Response:
        ...
        response = web.Response(
            body=b'This page is visible for all registered users', content_type='text/html')
        return response

    async def protected_page(self, request: web.Request) -> web.Response:
        await check_permission(request, 'protected')
        response = web.Response(body=b'You are on protected page', content_type='text/html')
        return response
